  ...
  return (
    ...
    <div className='h-[600px] relative bg-classic'>
            <div className='absolute top-0 left-0 backdrop-brightness-75 w-full h-full flex flex-col gap-3 justify-center items-center text-neutral-50 '>
              <div className='w-[800px] max-sm:w-full bg-[#000000b0] p-8 text-center flex flex-col gap-3'>
                <p className='font-bebas text-4xl max-sm:text-2xl'>{title}</p>
                <p className='text-2xl max-sm:text-base text-neutral-400'>
                  {writeup}
                </p>
              </div>
              <div>
